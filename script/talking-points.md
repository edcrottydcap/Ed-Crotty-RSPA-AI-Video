...
## Demo 2 — Multi-file → Report (Claude)
...
## Demo 5 — Pinpad Debug (Gemini Live)
...
- [ ] Photo of your Demo 1 object already taken and saved to desktop
- [ ] 2-3 industry docs saved to desktop (Demo 2)
- [ ] Sketch drawn on paper (Demo 3)
- [ ] Pinpad powered on at desk (Demo 5)
- [ ] Screen recording tool ready (Loom or TBD)
- [ ] Phone ready for Demo 5 Gemini Live
- [ ] Browser tabs pre-loaded: Gemini, Claude, ChatGPT
- [ ] Dry run of Demo 5 (Gemini Live + pinpad) — most likely to need a retry
- [ ] Good lighting for talking head (natural light or desk lamp facing you)

### Recording Order

Record each demo as its own clip — this way if one goes sideways, you only redo that one.

1. **Demo 1** — screen record: upload photo to Gemini in browser
2. **Demo 2** — screen record: upload files to Claude in browser
3. **Demo 3** — screen record: upload sketch to ChatGPT in browser
4. **PAUSE** — save the Demo 3 output image to your desktop
5. **Demo 4** — screen record: upload saved image to Gemini Veo in browser (let it generate, time-cut if needed)
6. **Demo 5** — phone camera: point at pinpad, use Gemini Live
7. **Intro** — talking head on phone (tripod, decent lighting, look at the lens)
8. **Outro** — talking head on phone (same setup)

**Tip:** Record intro + outro last. By then you've done all 5 demos and you'll sound more natural and confident talking about what you just showed.
